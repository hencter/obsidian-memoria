...
const zhCN: Dict = {
  ...
  "settings.storageMode.daily": "日记格式（每天一篇）⭐ 推荐",
  "settings.storageMode.yearly": "年格式（每年一篇）",
  "fab.aria": "新建笔记",
  "fab.close": "收起输入框",
...
const enUS: Dict = {
  ...
  "settings.storageMode.daily": "Daily (one file per day) ⭐ Recommended",
  "settings.storageMode.yearly": "Yearly (one file per year)",
  "fab.aria": "New memo",
