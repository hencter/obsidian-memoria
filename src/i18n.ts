...
const zhCN: Dict = {
  ...
  "stats.section.tagCloud": "☁️ 标签云",
  "stats.section.topTags": "🏷️ 最常用标签 Top 10",
  "stats.section.hourly": "⏰ 一天中你什么时候写得最多",
  ...
  "empty.onThisDaySub": "要不看看随机的 5 条旧笔记？",
  ...
  "settings.storageMode.name": "存储格式",
  "settings.storageMode.desc": "日记格式每天一个文件（YYYY-MM-DD.md）；年格式每年一个文件（YYYY.md），含 ## 日期分组。",
  ...
  "migration.doneError": "迁移完成：{merged} 条笔记已合并，{deleted} 个文件已处理，{errors} 个文件出错（详见控制台）",
  "settings.waterfall.name": "瀑布流卡片布局",
  "settings.waterfall.desc": "开启后卡片以瀑布流多列展示，去掉日期分组标题，适合视觉浏览。",
  "settings.editorHeight.name": "编辑器高度",
  "settings.editorHeight.desc": "编辑器初始高度（像素），内容超出时自动撑开，最大 55vh。",
  "settings.brandName.name": "品牌标题",
  "settings.brandName.desc": "顶栏左侧显示的品牌名称，留空则不显示文字，仅保留图标。",
  "fab.aria": "新建笔记",
  "fab.close": "收起输入框",
...
const enUS: Dict = {
  ...
  "settings.storageMode.name": "Storage format",
  "settings.storageMode.desc": "Daily: one file per day (YYYY-MM-DD.md). Yearly: one file per year (YYYY.md) with ## date sections.",
  ...
  "migration.doneError": "Migration done: {merged} memos merged, {deleted} files processed, {errors} files had errors (see console)",
  "settings.waterfall.name": "Waterfall layout",
  "settings.waterfall.desc": "Display cards in a multi-column masonry grid without date headers. Ideal for visual browsing.",
  "settings.editorHeight.name": "Editor height",
  "settings.editorHeight.desc": "Initial editor height in pixels. Auto-expands with content, max 55vh.",
  "settings.brandName.name": "Brand title",
  "settings.brandName.desc": "Brand name shown at the top-left of the top bar. Leave empty to show only the icon.",
  "fab.aria": "New memo",
